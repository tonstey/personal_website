    ...
    <>
      <section className="flex flex-1 flex-col items-center overflow-x-hidden">
        ...
        <div className="flex w-full flex-1 flex-wrap items-center justify-evenly gap-10 overflow-y-auto">
          {/* BEGIN EMAIL INQUIRY */}
          <div
            className="relative my-4 flex max-h-[95%] w-[20rem] flex-col gap-3 overflow-visible rounded-xl border border-[#e9deb0] bg-[#f2ede0] p-5 shadow-2xl md:my-0 md:w-[44rem] md:portrait:my-4 md:landscape:my-16"
            id="emailinquiry"
          >
            <img
            ...
            <div className="h-full overflow-y-auto">
              ...
              <div className="flex w-full flex-col">
                ...
                <textarea
                  className="h-12 w-full rounded-xl border border-[#74664B] bg-white p-3 text-sm text-[#91805e] md:text-lg"
                  rows="10"
                  value={message}
          ...
          {/* END EMAIL INQUIRY */}
          {/* BEGIN CONTACT INFO */}
          <div className="flex max-h-[95%] w-[20rem] flex-col items-center gap-6 overflow-y-auto rounded-xl border border-[#e9deb0] bg-[#f2ede0] p-4 shadow-2xl md:w-[24rem]">
